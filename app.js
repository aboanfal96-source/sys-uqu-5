...
async function doAct(id,action){
  ...
  try{
    ...
    var call=async function(q){var r=await fetch("/api/claude",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-sonnet-4-20250514",max_tokens:3000,system:SYS,messages:[{role:"user",content:q}]})});var d=await r.json();return d.content?d.content.map(function(b){return b.text||"";}).join(""):"";}
